...
@ComponentScan(basePackages = {
		...
		// mtyt
		"com.globits.mtyt.domain", "com.globits.mtyt.repository", "com.globits.mtyt.service",
		"com.globits.security.mtyt.impl",})

@EnableJpaRepositories(basePackages = { "com.globits.core.repository","com.globits.security.repository","com.globits.mtyt.repository" })
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("com.globits.core.domain","com.globits.security.domain","com.globits.mtyt.domain");
